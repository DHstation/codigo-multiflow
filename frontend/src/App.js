      ...
      createTheme(
        {
          ...
          palette: {
            ...
            primary: {
              ...
              light: mode === "light" ? `${primaryColorLight}80` : `${primaryColorDark}80`,
              dark: mode === "light" ? `${primaryColorLight}CC` : `${primaryColorDark}CC`,
              contrastText: "#ffffff",
            },
            textPrimary: mode === "light" ? primaryColorLight : primaryColorDark,
            ticketlist: mode === "light" ? primaryColorLight : primaryColorDark,
